...
public class SugestaoTrajetoAPIController {
	...
	public RespostaPadraoDTO aceitarPassageiro(@RequestBody AcaoMotoristaPassageiroDTO aceitarPassageiroDTO) {
		...
		SugestaoTrajetoUsuario motorista = this.sugestaoTrajetoServico.findMotoristaById(idMotorista);
	...
	@ResponseBody
	public RespostaPadraoDTO aceitarCaronaPassageiro(@RequestBody ConfirmaTrajetoPassageiroDTO confirmaTrajetoPassageiroDTO) {
		...
		SugestaoTrajetoPassageiro sugestaoTrajetoPassageiro = this.sugestaoTrajetoServico.findPassageiroById(passageiroId);
	...
	@ResponseBody
	public RespostaPadraoDTO arejeitarCaronaPassageiro(@RequestBody ConfirmaTrajetoPassageiroDTO confirmaTrajetoPassageiroDTO) {
