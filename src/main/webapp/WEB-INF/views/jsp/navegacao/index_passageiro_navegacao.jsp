      ...
      <link href="https://fonts.googleapis.com/css?family=Ubuntu" rel="stylesheet">
        ...
        <body>
          ...
          <div class="content">
            ...
            <h2>seu horário de saída:
              <span id="horario_saida_motorista"></span>
            </h2>
            ...
            <div class="form-group">
              ...
              <h3>Distância atual:
                <span id="distancia_atual_motorista_passageiro"></span> km
              </h3>
            </div>
          ...
          <script>
            ...
            CoordenadasParaDistancia.prototype.calcular = function(lat1, lon1, lat2, lon2) {
              // Haversine formula:

              var R = 6371; // Radius of the earth in km
              var dLat = this.grausParaRadianos(lat2 - lat1); // deg2rad below
              var dLon = this.grausParaRadianos(lon2 - lon1);
              var a = Math.sin(dLat / 2) * Math.sin(dLat / 2) + Math.cos(this.grausParaRadianos(lat1))
                  * Math.cos(this.grausParaRadianos(lat2)) * Math.sin(dLon / 2) * Math.sin(dLon / 2);
            ...
            CoordenadasParaDistancia.prototype.grausParaRadianos = function(grau) {
          ...
          <script>
            ...
            NavegacaoApp.prototype.atualizaLocalizacao = function () {
              ...
              navigator.geolocation.getCurrentPosition(function (position) {
                ...
                var distancia = app.coordenadasParaDistancia.calcular(motoristaLatitude, motoristaLongitude, passageiroLatitude, passageiroLongitude);

                console.log("distancia: " + distancia);
                console.log("motorista: latitude: " + motoristaLatitude + " longitude: " + motoristaLongitude);
                console.log("passageiro: latitude: " + passageiroLatitude + " longitude: " + passageiroLongitude);

                $("#distancia_atual_motorista_passageiro").text(parseFloat(distancia).toFixed(2));

              }, function () {
                alert('erro, sem acesso a localizacao')
              })
