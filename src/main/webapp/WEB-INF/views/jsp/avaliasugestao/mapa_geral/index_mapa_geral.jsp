...
<html>
  ...
  <head>
    ...
    <script id="box_usuario_info_marker" type="text/x-handlebars-template" src="${pageContext.request.contextPath}/resources/usuario_resumo_info_marker.js"></script>

    <script src="${pageContext.request.contextPath}/resources/mapa_geral.js"></script>
